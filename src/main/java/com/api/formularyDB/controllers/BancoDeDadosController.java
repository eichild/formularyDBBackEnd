...
public class BancoDeDadosController {
    ...
    @PostMapping
    public ResponseEntity<BancoDeDadosRequestDto> save(@RequestBody @Valid BancoDeDadosRequestDto objDTO) {
    ...
    @PutMapping("{id}")
    public ResponseEntity<BancoDeDadosRequestDto> update (@PathVariable(value = "id") int id_banco, @RequestBody @Valid BancoDeDadosRequestDto objDTO){
        BancoDeDadosModel bancoRequest = modelMapper.map(objDTO, BancoDeDadosModel.class);
        BancoDeDadosModel banco = bancoDeDadosService.save(objDTO);
        BancoDeDadosRequestDto bancoResponse = modelMapper.map(banco, BancoDeDadosRequestDto.class);
